...
import org.anonchatsecure.bramble.test.TestUtils.getRandomId
import org.anonchatsecure.bramble.util.StringUtils.getRandomString
import org.anonchatsecure.anonchat.api.autodelete.AutoDeleteConstants.NO_AUTO_DELETE_TIMER
...
import org.anonchatsecure.anonchat.api.identity.AuthorInfo.Status.UNVERIFIED
import org.anonchatsecure.anonchat.api.identity.AuthorInfo.Status.VERIFIED
...
import org.anonchatsecure.anonchat.api.messaging.event.PrivateMessageReceivedEvent
import org.anonchatsecure.anonchat.headless.ControllerTest
...
internal class MessagingControllerImplTest : ControllerTest() {
    ...
    @Test
    fun markMessageRead() {
        mockkStatic("org.anonchatsecure.anonchat.headless.RouterKt")
    ...
    fun testDeleteAllMessages() {
        ...
        every { conversationManager.deleteAllMessages(
            ContactId(
                1
            )
        ) } returns result
    ...
    private fun testNonexistentContactId(function: () -> Context) {
        ...
        every { contactManager.getContact(
            ContactId(
                42
            )
        ) } throws NoSuchContactException()
