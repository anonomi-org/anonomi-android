...
@UiThread
@NotNullByDefault
class GroupAudioPostViewHolder extends ThreadPostViewHolder<GroupMessageItem> {

	private static final Logger LOG =
			getLogger(GroupAudioPostViewHolder.class.getName());

	private final ImageButton playPause;
	private final SeekBar seekBar;
	private final TextView duration;

	GroupAudioPostViewHolder(View v) {
		super(v);
	...
	public void bind(GroupMessageItem item,
		...
		File tempFile;
		try {
			tempFile = File.createTempFile("group_voice", ".ogg",
