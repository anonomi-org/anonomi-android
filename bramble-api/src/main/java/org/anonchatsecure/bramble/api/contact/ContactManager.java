...
public interface ContactManager {
	...
	void setPanicContact(ContactId contactId, boolean panicContact) throws DbException;

	void setDistortedVoiceMessages(ContactId contactId, boolean distorted) throws DbException;
