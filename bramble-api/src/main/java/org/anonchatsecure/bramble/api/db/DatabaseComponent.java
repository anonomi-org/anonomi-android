...
public interface DatabaseComponent extends TransactionManager {
	...
	void updateContactPanicFlag(Transaction txn, ContactId c, boolean panic) throws DbException;

	void updateContactDistortedVoiceFlag(Transaction txn, ContactId c, boolean distorted) throws DbException;
