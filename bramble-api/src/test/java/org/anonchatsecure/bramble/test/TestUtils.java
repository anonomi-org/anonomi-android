...
import static org.anonchatsecure.bramble.api.crypto.CryptoConstants.MAX_AGREEMENT_PUBLIC_KEY_BYTES;
import static org.anonchatsecure.bramble.api.crypto.CryptoConstants.MAX_SIGNATURE_PUBLIC_KEY_BYTES;
...
import static org.anonchatsecure.bramble.api.sync.ClientId.MAX_CLIENT_ID_LENGTH;
import static org.anonchatsecure.bramble.api.sync.SyncConstants.MAX_GROUP_DESCRIPTOR_LENGTH;
...
public class TestUtils {
	...
	public static Contact getContact(ContactId c, Author remote, AuthorId local,
		...
		return new Contact(c, remote, local,
				...
				getAgreementPublicKey(), verified, false, false);
	}
