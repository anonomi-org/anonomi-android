...
import org.anonchatsecure.bramble.api.mailbox.MailboxAuthToken;
...
import static org.anonchatsecure.bramble.api.client.ContactGroupConstants.GROUP_KEY_CONTACT_ID;
import static org.anonchatsecure.bramble.api.identity.Author.FORMAT_VERSION;
import static org.anonchatsecure.bramble.api.identity.AuthorConstants.MAX_AUTHOR_NAME_LENGTH;
import static org.anonchatsecure.bramble.api.identity.AuthorConstants.MAX_PUBLIC_KEY_LENGTH;
import static org.anonchatsecure.bramble.api.mailbox.MailboxUpdateManager.PROP_COUNT;
...
import static org.anonchatsecure.bramble.api.mailbox.MailboxUpdateManager.PROP_ONION_LENGTH;
import static org.anonchatsecure.bramble.api.properties.TransportPropertyConstants.MAX_PROPERTIES_PER_TRANSPORT;
import static org.anonchatsecure.bramble.api.properties.TransportPropertyConstants.MAX_PROPERTY_LENGTH;
