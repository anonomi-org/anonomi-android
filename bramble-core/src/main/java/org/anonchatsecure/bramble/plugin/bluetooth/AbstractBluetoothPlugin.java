...
import org.anonchatsecure.bramble.api.keyagreement.KeyAgreementConnection;
import org.anonchatsecure.bramble.api.keyagreement.KeyAgreementListener;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementListeningEvent;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementStoppedListeningEvent;
import org.anonchatsecure.bramble.api.lifecycle.IoExecutor;
import org.anonchatsecure.bramble.api.plugin.Backoff;
import org.anonchatsecure.bramble.api.plugin.ConnectionHandler;
import org.anonchatsecure.bramble.api.plugin.PluginCallback;
import org.anonchatsecure.bramble.api.plugin.PluginException;
...
import org.anonchatsecure.bramble.api.properties.event.RemoteTransportPropertiesUpdatedEvent;
import org.anonchatsecure.bramble.api.rendezvous.KeyMaterialSource;
import org.anonchatsecure.bramble.api.rendezvous.RendezvousEndpoint;
...
import static org.anonchatsecure.bramble.api.keyagreement.KeyAgreementConstants.TRANSPORT_ID_BLUETOOTH;
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.DEFAULT_PREF_ADDRESS_IS_REFLECTED;
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.DEFAULT_PREF_EVER_CONNECTED;
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.ID;
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.PREF_ADDRESS_IS_REFLECTED;
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.PREF_EVER_CONNECTED;
...
import static org.anonchatsecure.bramble.api.plugin.BluetoothConstants.UUID_BYTES;
...
import static org.anonchatsecure.bramble.api.properties.TransportPropertyConstants.REFLECTED_PROPERTY_PREFIX;
...
import static org.anonchatsecure.bramble.util.StringUtils.macToBytes;
import static org.anonchatsecure.bramble.util.StringUtils.macToString;
