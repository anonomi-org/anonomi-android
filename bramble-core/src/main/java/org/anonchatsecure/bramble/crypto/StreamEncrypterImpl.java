...
import org.anonchatsecure.bramble.api.crypto.StreamEncrypter;
...
import static org.anonchatsecure.bramble.api.transport.TransportConstants.FRAME_HEADER_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.FRAME_HEADER_PLAINTEXT_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.FRAME_NONCE_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.MAC_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.MAX_FRAME_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.MAX_PAYLOAD_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.PROTOCOL_VERSION;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.STREAM_HEADER_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.STREAM_HEADER_NONCE_LENGTH;
import static org.anonchatsecure.bramble.api.transport.TransportConstants.STREAM_HEADER_PLAINTEXT_LENGTH;
