...
import org.anonchatsecure.bramble.api.cleanup.event.CleanupTimerStartedEvent;
...
import org.anonchatsecure.bramble.api.contact.event.ContactVerifiedEvent;
...
import org.anonchatsecure.bramble.api.db.CommitAction;
import org.anonchatsecure.bramble.api.db.CommitAction.Visitor;
...
import org.anonchatsecure.bramble.api.db.EventAction;
...
import org.anonchatsecure.bramble.api.db.NoSuchIdentityException;
...
import org.anonchatsecure.bramble.api.db.NullableDbCallable;
import org.anonchatsecure.bramble.api.db.PendingContactExistsException;
import org.anonchatsecure.bramble.api.db.TaskAction;
...
import org.anonchatsecure.bramble.api.identity.event.IdentityAddedEvent;
import org.anonchatsecure.bramble.api.identity.event.IdentityRemovedEvent;
...
import org.anonchatsecure.bramble.api.sync.Offer;
import org.anonchatsecure.bramble.api.sync.Request;
...
import org.anonchatsecure.bramble.api.sync.event.GroupVisibilityUpdatedEvent;
import org.anonchatsecure.bramble.api.sync.event.MessageAddedEvent;
import org.anonchatsecure.bramble.api.sync.event.MessageRequestedEvent;
import org.anonchatsecure.bramble.api.sync.event.MessageSharedEvent;
import org.anonchatsecure.bramble.api.sync.event.MessageStateChangedEvent;
import org.anonchatsecure.bramble.api.sync.event.MessageToAckEvent;
import org.anonchatsecure.bramble.api.sync.event.MessageToRequestEvent;
...
import org.anonchatsecure.bramble.api.sync.event.SyncVersionsUpdatedEvent;
...
import static org.anonchatsecure.bramble.db.DatabaseConstants.MAX_OFFERED_MESSAGES;
...
class DatabaseComponentImpl<T> implements DatabaseComponent {
	...
	@Override
	public void updateContactPanicFlag(Transaction txn, ContactId c, boolean panic) throws DbException {
		T realTxn = unbox(txn);
		db.updateContactPanicFlag(realTxn, c, panic);
	}

	@Override
	public void updateContactDistortedVoiceFlag(Transaction txn, ContactId c, boolean distorted) throws DbException {
		T realTxn = unbox(txn);
		db.updateContactDistortedVoiceFlag(realTxn, c, distorted);
	}
