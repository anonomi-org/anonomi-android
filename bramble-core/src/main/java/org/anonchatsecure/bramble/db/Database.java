...
interface Database<T> {
	...
	void updateContactPanicFlag(T txn, ContactId c, boolean panic) throws DbException;

	void updateContactDistortedVoiceFlag(T txn, ContactId c, boolean distorted) throws DbException;
