...
import static org.anonchatsecure.bramble.api.sync.validation.IncomingMessageHook.DeliveryAction.DEFER;
import static org.anonchatsecure.bramble.api.sync.validation.IncomingMessageHook.DeliveryAction.REJECT;
import static org.anonchatsecure.bramble.api.transport.agreement.TransportKeyAgreementManager.CLIENT_ID;
import static org.anonchatsecure.bramble.api.transport.agreement.TransportKeyAgreementManager.MAJOR_VERSION;
...
import static org.anonchatsecure.bramble.transport.agreement.State.ACTIVATED;
import static org.anonchatsecure.bramble.transport.agreement.State.AWAIT_ACTIVATE;
import static org.anonchatsecure.bramble.transport.agreement.State.AWAIT_KEY;
import static org.anonchatsecure.bramble.transport.agreement.TransportKeyAgreementConstants.MSG_KEY_MESSAGE_TYPE;
import static org.anonchatsecure.bramble.transport.agreement.TransportKeyAgreementConstants.MSG_KEY_PUBLIC_KEY;
