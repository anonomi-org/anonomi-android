...
import org.anonchatsecure.bramble.api.record.Record;
import org.anonchatsecure.bramble.api.record.RecordReader;
import org.anonchatsecure.bramble.api.record.RecordReader.RecordPredicate;
...
import org.anonchatsecure.bramble.api.sync.Priority;
...
import org.anonchatsecure.bramble.test.PredicateMatcher;
...
import static org.anonchatsecure.bramble.api.record.Record.MAX_RECORD_PAYLOAD_BYTES;
import static org.anonchatsecure.bramble.api.sync.RecordTypes.ACK;
import static org.anonchatsecure.bramble.api.sync.RecordTypes.MESSAGE;
import static org.anonchatsecure.bramble.api.sync.RecordTypes.OFFER;
import static org.anonchatsecure.bramble.api.sync.RecordTypes.PRIORITY;
import static org.anonchatsecure.bramble.api.sync.RecordTypes.REQUEST;
import static org.anonchatsecure.bramble.api.sync.RecordTypes.VERSIONS;
...
import static org.anonchatsecure.bramble.api.sync.SyncConstants.MAX_SUPPORTED_VERSIONS;
import static org.anonchatsecure.bramble.api.sync.SyncConstants.MESSAGE_HEADER_LENGTH;
import static org.anonchatsecure.bramble.api.sync.SyncConstants.PRIORITY_NONCE_BYTES;
import static org.anonchatsecure.bramble.api.sync.SyncConstants.PROTOCOL_VERSION;
